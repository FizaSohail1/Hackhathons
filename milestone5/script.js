    ...
    if (resumeForm) {
        resumeForm.addEventListener('submit', function (event) {
            ...
            if (resumeDisplay) {
                ...
                var editBtn_1 = document.getElementById('editBtn');
                var saveBtn_1 = document.getElementById('saveChanges');
                var editableSections_1 = document.querySelectorAll('.editable-section');
                editBtn_1.addEventListener('click', function () {
                    editableSections_1.forEach(function (section) {
                        section.contentEditable = 'true';
                    });
                    editBtn_1.style.display = 'block';
                    saveBtn_1.style.display = 'inline';
